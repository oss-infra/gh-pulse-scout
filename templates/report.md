...
- Use exactly these three short sections, in this order, each as a level-3 heading (`###`). Translate the heading names to the target language; the English names below are only a structural reference:
